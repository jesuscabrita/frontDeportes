...
interface TableEquiposLigamasterProps {
    light: boolean;
    dataEquiposLigamaster: {
        name: string;
        logo: string;
        categoria: string;
        subCategoria: string;
...
export const TableEquiposLigamaster: React.FC<TableEquiposLigamasterProps> = ({
    light,
    dataEquiposLigamaster,
    mobile,
    queryClient,
    ...
    return (
        <Grid item container>
            {dataEquiposLigamaster.length === 0 ?
                ...
                : <TableContainer component={Paper}>
                    <Table aria-label="collapsible table">
                        ...
                        {dataEquiposLigamaster && dataEquiposLigamaster?.map((equipo, index) => {
