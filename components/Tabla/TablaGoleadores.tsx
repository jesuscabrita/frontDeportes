                                ...
                                <Table aria-label="customized table">
                                    <TableHead>
                                        <TableRow>
                                            ...
                                            <StyledTableCell light={light} align={!mobile ? "center" : "right"}>Goles</StyledTableCell>
                                            <StyledTableCell light={light} align="center" style={{ whiteSpace: 'nowrap' }}>{mobile ? 'PJ' : 'Partidos Jugados'}</StyledTableCell>
                                            <StyledTableCell light={light} align="right" style={{ whiteSpace: 'nowrap' }}>{mobile ? 'GP' : 'Goles por partido'}</StyledTableCell>
                                        </TableRow>
                                    </TableHead>
